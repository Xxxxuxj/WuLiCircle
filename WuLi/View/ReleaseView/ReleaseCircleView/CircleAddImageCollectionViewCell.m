//
//  CircleAddImageCollectionViewCell.m
//  WuLi
//
...
@implementation CircleAddImageCollectionViewCell
...
///更新数据
-(void)deleteImage{
    [[NSNotificationCenter defaultCenter]postNotificationName:@"deleteCircleAddedImage" object:nil userInfo:@{@"index":[NSString stringWithFormat:@"%lu",self.index]}];
