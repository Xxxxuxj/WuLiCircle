...
@interface TitleCollectionViewCell() <UITextViewDelegate>
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(TitleResignFirstResponder) name:@"TitleResignFirstResponder" object:nil];
        [self setUI];
    }
    return self;
}
...
- (void)textViewDidEndEditing:(UITextView *)textView{
    [[NSNotificationCenter defaultCenter]postNotificationName:@"submitInformation" object:nil userInfo:@{@"commodityTitle":self.titleTextView.text}];
}
